      ...
      <footer className={styles.footer}>
        <div className={styles.container}>
          <div className={styles.logo}>
            ...
            <Link href="/">
              <Image src="/logo.png" width={150} height={150} alt="mas" />
            </Link>
          </div>
          ...
          <div className={styles.column}>
            ...
            <p className={styles.contactInfo}>Teléfono: +1 234 567 890</p>
            <p className={styles.contactInfo}>Email: info@example.com</p>
          </div>
          <div className={styles.column}>
        ...
        <div className={styles.bottomBar}>
          ...
          &copy; {new Date().getFullYear()} VeroBlend. Todos los derechos
          reservados. VeroBlend es una marca registrada de VeroBlend. Prohibida
