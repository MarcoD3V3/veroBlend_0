	...
	return (
		<div className={styles.FileUploader}>
			<div {...getRootProps()} className={styles.containerFileUploader}>
				...
				{isDragActive ? <p>Suelta los archivos aquí...</p> : <p>Arrastra y suelta los archivos aquí, o haz clic para seleccionar los archivos</p>}
			</div>
			<div>
				{imageProps}
			</div>
			<div>
				...
				{imageUrl && <Image src={imageUrl} alt="User's Image" width={200} height={200} />}
			</div>
		</div>
	);
};
